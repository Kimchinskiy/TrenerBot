...
import { Card, ScreenHeader, Spinner, Empty, ErrorBox, Row } from '../components/ui'
...
export default function Debtors({ onBack }: { onBack: () => void }) {
  const [days, setDays] = useState(30)
  const { data, isLoading, error } = useDebtors(days)

  return (
    <div>
      <ScreenHeader title="Должники" subtitle="Пропущенные тренировки за период" onBack={onBack} />
