...
import { Card, ScreenHeader, Spinner, Button, Empty, ErrorBox } from '../components/ui'
...
export default function Wellbeing({ onBack }: { onBack: () => void }) {
  const me = useMe()
  ...
  return (
    <div>
      <ScreenHeader title="Самочувствие" subtitle="Оцените тренировку" onBack={onBack} />
