...
type GroupMember struct {
	...
	StudentID  int64  `json:"client_id"`
	Role       string `json:"role"`
	JoinedAt   string `json:"joined_at"`
	StudentName string `json:"client_name,omitempty"`
}
...
type ScheduleEntry struct {
	...
	Time        string       `json:"time"`
	StudentID   int64        `json:"client_id"`
	StudentName string       `json:"client_name"`
	CoachID     *int64       `json:"coach_id,omitempty"`
	Duration    int          `json:"duration"`
	Status      LessonStatus `json:"status"`
	GroupID     *int64       `json:"group_id,omitempty"`
...
type StatisticsResponse struct {
	...
	Students      MetricValue    `json:"clients"`
...
type QuickOverview struct {
	NewStudents   int     `json:"new_clients"`
